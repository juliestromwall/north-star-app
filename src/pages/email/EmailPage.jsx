        ...
        {saved ? (
          ...
          <>
            <div className="space-y-3">
              ...
              {selectedCase && (
                <div className="space-y-1.5">
                  <label className="text-[11px] text-stone-400 font-medium uppercase tracking-wider">Tag <span className="text-rose-500">*</span></label>
            ...
            <DialogFooter>
              ...
              <Button onClick={handleLog} disabled={saving || !selectedCase || !selectedTag}>
