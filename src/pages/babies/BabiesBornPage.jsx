...
const DEFAULT_DATA = {
  ...
  years: [
    ...
    { year: 2017, births: 13, twins: 2, notes: '2 twins' },
    { year: 2018, births: 23, twins: 3, notes: '3 twins' },
    { year: 2019, births: 22, twins: 0, notes: '' },
    { year: 2020, births: 16, twins: 0, notes: '' },
    { year: 2021, births: 24, twins: 1, notes: '1 twin' },
    { year: 2022, births: 10, twins: 1, notes: '1 twin' },
    { year: 2023, births: 16, twins: 0, notes: '' },
    { year: 2024, births: 34, twins: 1, notes: '1 twin' },
