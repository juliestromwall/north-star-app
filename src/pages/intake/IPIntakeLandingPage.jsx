...
export default function IPIntakeLandingPage() {
    ...
    <div className="min-h-screen" style={{ backgroundColor: '#faf8f5' }}>
      ...
      <div className="max-w-2xl mx-auto px-5 pt-14 pb-10 text-center">
        <button
          ...
          style={{ background: 'linear-gradient(135deg, #283693, #ed148c)', color: '#fff' }}>
          <Clock className="w-4 h-4" />
          Connect with our team in less than 5 minutes.
        </button>
        <h1 className="text-4xl sm:text-5xl font-bold text-stone-900 leading-tight mb-4">
          <span style={{ color: '#283693' }}>Ready to build</span>{' '}
          <span style={{ color: '#ed148c' }}>your family?</span>
        </h1>
        <p className="text-stone-500 text-lg leading-relaxed max-w-lg mx-auto">
          Share a few details about your surrogacy journey and our team will reach out within 48 hours to discuss next steps.
        </p>
      ...
      <div className="max-w-md mx-auto px-5 pb-16">
        <button
          ...
          onMouseEnter={e => e.currentTarget.style.borderColor = '#283693'}
        ...
        >
          ...
          <p className="text-sm text-stone-500 leading-relaxed flex-1 mb-6">
            Learn how surrogacy with Abundant Beginnings can work for you — compassionate, experienced guidance from your first call through your baby's birth.
          </p>
          <div className="flex items-center gap-2 text-sm font-semibold" style={{ color: '#283693' }}>
            Get started
        ...
        <div className="max-w-2xl mx-auto px-5 text-center">
          ...
          <div className="grid grid-cols-3 gap-6">
            {STATS.map(({ stat, label }) => (
              <div key={label}>
                <div className="text-2xl sm:text-3xl font-bold" style={{ color: '#283693' }}>{stat}</div>
