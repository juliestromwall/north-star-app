    ...
    <div className="min-h-screen bg-abc-cream">
      ...
      <header className="sticky top-0 z-50 bg-white/90 backdrop-blur border-b border-border print:hidden">
        <div className="max-w-3xl mx-auto px-4 py-3 flex items-center justify-between">
          <img src="/abc-logo.png" alt="ABC Surrogacy" className="h-8" />
      ...
      <main className="max-w-3xl mx-auto px-4 py-8 space-y-6">
        ...
        <div className="text-center py-8 space-y-3">
          <img src="/abc-logo.png" alt="ABC Surrogacy" className="h-6 mx-auto opacity-60" />
          <p className="text-sm text-muted-foreground">
            Interested in learning more? <span className="font-medium text-abc-indigo">Contact your coordinator at ABC Surrogacy.</span>
          </p>
        </div>
      </main>
    </div>
