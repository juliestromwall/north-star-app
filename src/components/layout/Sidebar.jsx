  ...
  return (
    <>
      ...
      {onToggle ? (
        ...
        >
          {collapsed ? (
            <img src="/first-star-mark.png" alt="First Star Surrogacy" className="h-8 w-auto object-contain" />
          ) : (
            <img src="/first-star-logo-sidebar.svg" alt="First Star Surrogacy" className="w-full h-auto" />
          )}
        </button>
      ) : (
