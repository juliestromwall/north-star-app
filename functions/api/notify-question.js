    ...
    <div style="font-family: system-ui, -apple-system, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff;">
      ...
      <div style="padding: 0 32px 32px;">
        ...
        <div style="text-align: center; margin: 24px 0;">
          <a href="https://app.firststarsurrogacy.com/matching" style="display: inline-block; background: #1A3638; color: white; padding: 14px 36px; border-radius: 8px; text-decoration: none; font-weight: 600; font-size: 14px;">
            View in App
          </a>
        </div>
