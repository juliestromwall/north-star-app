      ...
      <div style="padding: 0 32px 32px;">
        ...
        <div style="margin: 20px 0 24px;">
          <p style="font-size: 14px; color: #44403c; line-height: 1.7;">
            Thank you for reaching out to First Star Surrogacy (First Star Surrogacy). We're truly honored that you've considered us to be a part of your journey.
          </p>
        ...
        <div style="text-align: center; margin: 24px 0;">
          ...
          <img src="https://app.firststarsurrogacy.com/first-star-logo.png" alt="Owner Jenn Maatman" style="max-width: 100%; border-radius: 12px;" />
        </div>
    ...
    try {
      await fetch('https://api.resend.com/emails', {
        ...
        body: JSON.stringify({
          ...
          to: [email],
          subject: 'First Star Surrogacy has received your information',
          html: htmlBody,
        }),
      })
    } catch (err) {
