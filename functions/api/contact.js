...
// Sends the public marketing-site "Contact Us" form to the First Star inbox.
// Defaults to hello@firststarsurrogacy.com (override with CONTACT_NOTIFY_EMAIL).
...
export async function onRequestPost(context) {
  ...
  const fromEmail = env.WELCOME_FROM_EMAIL || 'noreply@firststarsurrogacy.com'
  const notifyEmail = env.CONTACT_NOTIFY_EMAIL || 'hello@firststarsurrogacy.com'
