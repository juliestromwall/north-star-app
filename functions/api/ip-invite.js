    ...
    <div style="font-family: system-ui, -apple-system, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff;">
      ...
      <div style="padding: 0 32px 32px;">
        ...
        <p style="color: #78716c; text-align: center; font-size: 14px; margin: 0 0 24px;">
          First Star Surrogacy has set up your intended parent account
        </p>
        ...
        <div style="background: linear-gradient(135deg, #fef9fb, #f0f1fa); border-radius: 12px; padding: 20px; margin: 0 0 24px;">
          ...
          <p style="margin: 8px 0 0; font-size: 14px; color: #44403c; line-height: 1.6;">
            Your account has been created at <strong><a href="https://app.firststarsurrogacy.com" style="color: #1A3638; font-weight: 600;">app.firststarsurrogacy.com</a></strong>. Click the button below to set your password and access your portal.
          </p>
        </div>
