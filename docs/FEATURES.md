...
| FaxPage | src/pages/fax/FaxPage.jsx | SRFax integration: send fax (upload or pick from case documents), received fax inbox with PDF preview, file received fax to case Medical Records (searchable case selector, rename), cover pages, "Send Fax" button on Surrogate/IP/Journey Documents tabs |
...
| Date | Change |
|------|--------|
| 2026-04-03 | Fax: SRFax credentials configured, full fax overhaul — send fax from case documents (pick document from case), received fax inbox with PDF preview, file received fax to case Medical Records (searchable case selector, rename document), "Send Fax" button on Surrogate/IP/Journey Documents tabs. New db.js helper: uploadBase64ToCaseDocuments for filing fax PDFs. |
