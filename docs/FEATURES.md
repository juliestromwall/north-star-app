...
| FloatingStickyNotes | src/components/shared/FloatingStickyNotes.jsx | Draggable persistent post-it notes that float on all pages. 5 colors, click to edit, minimize to TopBar pills (via React portal), per-user Supabase storage. Admin-only. |
